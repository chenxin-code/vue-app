                  ...
                  <div>
                    ...
                    <div class="base-info theme_bg_white">
                      <div class="price">
                        ...
                        <span class="price-z theme_font_red" style="margin-left: -4px;">{{getInteger(detailData.activityPrice)}}</span>
                        <span class="font-small price-z theme_font_red" style="margin-left: -4px; font-weight: 700;">.{{getDecimals(detailData.activityPrice)}}</span>
                        <!-- &nbsp;&nbsp;
...
export default {
        ...
        .then(action => {
          ...
          this.$http
            ...
            .then(res => {
              this.$Loading.close();
              if (res.data.status == 0) {
                this.$Toast(`${this.objStype.queryType == 1 ? "下架" : "上架"}成功!`);
                this.objStype.queryType = this.objStype.queryType == 1 ? "0" : "1";
                let objStype = JSON.parse(sessionStorage.getItem('objStype'))
                if (objStype) {
                  objStype.queryType = this.objStype.queryType
                  sessionStorage.setItem('objStype',JSON.stringify(objStype))
                }
              } else {
                this.$Toast(res.data.info);
              }
  ...
  created() {
    this.isRecommend = Number(this.$route.query.isRecommend)
      console.log('isRecommend',this.$route.query.isRecommend )
    ...
    console.log(1,this.$route.query.obj,this.$route.query.listData)
    if (this.$route.query.obj) {
      if (Object.prototype.toString.call(this.$route.query.obj) == "[object String]" || Object.prototype.toString.call(this.$route.query.obj) == "[object object]") {
    ...
    console.log(2,this.objStype,this.listData)
