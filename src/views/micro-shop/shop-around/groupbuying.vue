  ...
  <div class="list">
      <div class="all-content" ref="allContent" v-infinite-scroll="loadMore" infinite-scroll-disabled="loading" :infinite-scroll-immediate-check="true" infinite-scroll-distance="100">
        ...
        <div class="shop-background"
            ...
            style="height: 80px;">
          <div class="newSearch" ref="newSearch" id='newSearch' style="backgroundColor : #fff">
        ...
        <div class="shop-background" id='shop-background'  v-if='$store.state.webtype == 2' style="height: 50px;">
          <div class="search" ref="search" id='search' style="backgroundColor : #fff">
        ...
        <list ref="listFun" @productEvent="productEvent" @addShopping="addShopping" @listData="listData" @listStatus='listStatus' @refresh='refresh' :params="params" :styleObj="styleObj" :screenArr="screenArr" />
...
export default {
  ...
  methods: {
    ...
    productEvent(product) {
        this.lastPath = "";
        let path = "/micro_sho/sharebuyingDetail/" + this.$util.getDataString();
        this.$router.push({
            path: path,
            query: {
                id: product.skuId,
