  ...
  <div class="detail mall2">
    <div class="detail-content" v-if="loaded">
      ...
      <div class="bottom-btns" v-if="loaded">
        ...
        <div class="btn theme_bg_y theme_font_white" @click="showPop = true" >
          <p class="title">立即购买</p>
        </div>
<!--        <div class="btn big-btn theme_bg_y theme_font_white">-->
    ...
    export default {
        ...
        methods: {
            ...
            getPurchaseDetail: function () {
              console.log(this.$store.state.mall2,'this.$store.state.mall2')
                let url = '/app/json/pro_sku_purchase/queryPurchaseDetail'
                let paramsData = {
                    id: this.id,
                  deliverType:this.$store.state.mall2.staticDeliverType,
                  pickupStoreOuCode:this.$store.state.mall2.staticDeliverType==1?this.$store.state.mall2.zitiAddress.storeCode:''
        ...
        created() {
            ...
            console.log(this.microStoreCode,this.proSkuDistributionId)
