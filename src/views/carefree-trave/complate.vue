<template>
  <div class="body">
    ...
    <nav-content>
      ...
      <div class="bg"></div>
<!--      <div class="box box1">-->
<!--        <div><span>审批意见</span><span>同意退票</span></div>-->
<!--        <div><span>审批时间</span><span>2019.02.02  12:12:2</span></div>-->
<!--        <div><span>审批备注</span><span>暂无</span></div>-->
<!--      </div>-->
      ...
      <div class="box div3">
        <p>申请备注</p>
        <textarea name="" v-model="detailObj.remark" id="" cols="20" rows="5" placeholder="情况有变，临时计划变更！"></textarea>
      </div>
    </nav-content>
  </div>
</template>
