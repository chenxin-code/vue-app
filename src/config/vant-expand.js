...
Vue.use(List).use(IndexBar).use(IndexAnchor).use(Progress).use(Circle).use(Col).use(Row).use(Empty).use(CountDown).use(Sticky).use(ShareSheet).use(Uploader).use(NavBar).use(Toast).use(Popover)
