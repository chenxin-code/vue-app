  ...
  <div>
    <div class="product-message">
      <div style="display: flex">
        <img
          src="@assets/images/order/travel-icon.png"
          alt=""
          class="travel-icon"
        />
    ...
    <div class="trip-people-message">
      <div class="trip-header">
        <div class="left">
          <img src="@assets/images/travel/card-icon.png" />
      ...
      <div v-for="(item, index) in defaultRecords" :key="index">
        <div class="trip-list-people" v-if="item.isActive">
          <div class="trip-item">
            <img
              src="~@assets/images/travel/del.png"
              @click="changeActive(item)"
            />
    ...
    <div class="linkman-message">
      <div class="linkman-header">
        <div class="left">
          <img src="@assets/images/travel/link-people.png" />
...
export default {
  ...
  activated() {
    ...
    // this.totalPrize =
    //   mathFunction.times(audltNum, adultPrices) +
    //   mathFunction.times(childNum, childPrices);
