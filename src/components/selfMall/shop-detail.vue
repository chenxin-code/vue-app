...
<template>
  <div class="list">
    <nav-top title="店铺详情" @backEvent="backEvent" />
    <nav-content>
      <div class="all-content" v-if="shopDetail">
        <div class="shop-content" ref="shopContent" id="shopContent">
          ...
          <div class="shop-introduce">
            <div class="shop-name">
              <div class="text-col_1">麦当劳(北七家店)</div>
              <div class="text-col_2">营业中</div>
            </div>
            <div class="service-group">
              <div class="service-item s1">加油</div>
              <div class="service-item s2">加水</div>
              <div class="service-item s3">厕所</div>
              <div class="service-item s4">充值</div>
            </div>
            <div class="coupon-receive">
              <div class="coupon-receive-list">
                <div class="coupon-recerve-text">￥<i class="i1">10</i>满50元可用</div>
                <div class="coupon-recerve-status">领</div>
              </div>
              <div class="coupon-receive-list received">
                <div class="coupon-recerve-text">￥<i class="i1">5</i>满20元可用</div>
                <div class="coupon-recerve-status">已领</div>
              </div>
            </div>
            <div class="coupon-group">
              <div class="coupon-list">满20减2</div>
              <div class="coupon-list">满50减10</div>
              <div class="coupon-list">满100减20</div>
            </div>
          </div>
        </div>
        <div class="shop-pro-list" ref="shopProList">
          <div class="shop-nav">
            ...
            <div class="shop-nav-item" :class="{active: curNav === 1}" @click="curNav = 1"><span class="con">店铺介绍</span>
            </div>
          </div>
...
<script>
  import CardList from '../mall2/list/base/card-list'
  import DetailList from '../mall2/list/base/detail-list'
  import Filtrate from '../mall2/list/filtrate/index'
  import Search from '../mall2/common/search'
  import cartJS from  '../mall2/cart/js/cart'
  import GiftList from '../mall2/common/giftlist'
  import PullTo from '@/components/Vendor/vue-pull-to/vue-pull-to'
  import Category from '../mall2/list/category/index'
  import Countdown from "@/components/Vendor/countdown/countdown";
  import Recommend from '../mall2/list/recommend/index'
      ...
      .shop-introduce{
        ...
        .coupon-receive{
          ...
          .coupon-receive-list{
            ...
            &.received{
              .coupon-recerve-text{
                border-right:1px dashed #F93337;
                color:#F93337;
