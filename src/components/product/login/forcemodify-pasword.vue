      ...
      <form class="form">
        <div class="cells">
          <div class="cell cell-line">
            ...
            <div class="cell__bd">
              <input type="number" pattern="[0-9]*" placeholder="请输入手机号" v-model="phone" oninput="if(value.length>11) value=value.slice(0,11)">
            </div>
          </div>
          <div class="cell cell-line">
            <div class="cell__hd">
            ...
            <div class="cell__bd">
              <input type="text" placeholder="请输入图片验证码" v-model="imgVerifyCode">
            </div>
            <div class="cell__ft">
          ...
          <div class="cell cell-line">
            ...
            <div class="cell__bd">
              <input type="text" placeholder="请输入手机验证码" v-model="smsVerifyCode" :disabled="smsInputStates">
            </div>
            <div class="cell__ft">
  ...
  export default {
    ...
    methods: {
      ...
      nextEvent: function() {
        ...
        // 校验短信验证码
        this.$Loading.open();
        let url = '/app/json/user/verifyForceModifyPwdSms';
      ...
      _sendVerifyRegSms: function() {
        ...
        let url = '/app/json/message/sendVerifyForceModifyPwdSms';
