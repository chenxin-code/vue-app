<template>
  <div class="signin login-about full-view">
    <div class="full-form">
      <!--<div>-->
        <!--请输入未在95504注册的手机号-->
      <!--</div>-->
      <form class="form">
        <div class="cells">
          <div class="cell cell-line">
            ...
            <div class="cell__bd">
              <input type="text" placeholder="请输入用户名" v-model="username" disabled="disabled">
            </div>
          </div>
          <div class="cell cell-line">
            <div class="left-text">
            ...
            <div class="cell__bd">
              <input type="text" placeholder="请输入身份证号" v-model="cardNum" disabled="disabled" >
            </div>
          </div>
          <div class="cell cell-line">
            <div class="left-text">
            ...
            <div class="cell__bd">
              <input type="number" pattern="[0-9]*" placeholder="请输入绑卡手机号" v-model="phone" disabled="disabled" oninput="if(value.length>11) value=value.slice(0,11)">
            </div>
          </div>
          <div class="cell cell-line">
            <div class="left-text">
            ...
            <div class="cell__bd">
              <input type="text" placeholder="请输入验证码" v-model="imgVerifyCode">
            </div>
            <div class="cell__ft">
          ...
          <div class="cell cell-line">
            ...
            <div class="cell__bd">
              <input type="text" placeholder="请输入手机号" v-model="smsVerifyCode" :disabled="smsInputStates">
            </div>
            <div class="cell__ft">
  ...
  export default {
    ...
    methods: {
      ...
      nextEvent: function () {
        ...
        // 校验短信验证码
        Indicator.open();
        let url = '/app/json/card/verifyReservePhoneSmsLogin';
...
//              });
      ...
      _sendVerifyRegSms: function () {
        Indicator.open('验证码正在发送');
        let url = '/app/json/card/sendReservePhoneSms';
      ...
      getData:function(){
        ...
        this.cardNum = this.userInfo.idNumber;
      },
    },
  };
</script>
