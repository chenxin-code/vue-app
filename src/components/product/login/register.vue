<template>
	<div class="signin login-about full-view">
			...
			<form class="form">
				<div class="cells">
					...
					<div class="cell cell-line">
						...
						<div class="cell__bd">
							<input type="text" placeholder="输入图片校验码" v-model="imgVerifyCode" oninput="if(value.length>4) value=value.slice(0,4)">
						</div>
						<div class="cell__ft">
		...
		<div class="btn-box">
			<div class="btn" @click="goToSetPwd">
				下一步
			</div>
		</div>
		<div class="col">
			<div class="col-cell">
				...
				<div class="col-item" @click="goToLogin">去登录</div>
			</div>
		</div>
	</div>
</template>
	...
	methods: {
      ...
      if (this.smsVerifyCode === '') {
        ...
        return;
			...
			// 校验短信验证码
      this.$Loading.open();
			let url = '/app/json/login/verifyRegisterSmsCode';
      ...
      this.$Loading.open('验证码正在发送');
			let url = '/app/json/message/sendVerifyRegSms';
