/**Created by liaoyingchao on 2019-04-29.*/
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      const _this = this
      // const init = {
      //   language_url: 'static/tinymce/skins/langs/zh_CN.js',
      //   language: 'zh_CN',
  ...
  //         'toolbar_items_size': 'small',
      ...
      this.$assign(setting, _this.setting)
