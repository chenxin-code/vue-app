    ...
    <pop-view v-if="showPop" @closeEvent="popClose">
      <div class="pop-body">
        ...
        <div class="bottom-btn theme_font_white theme_bg_red" @click="popSureEvent"
             v-if="popFlag == 'addToCart' && stockNum != 0 && canSale == true && detailData.status != '0' && detailData.supportPreSale != '1' && detailData.productType != 8">
          加入购物车
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      _getProductDetail: function () {
        ...
        if (paramsData.deliverType == 1 || paramsData.secondDeliveType == 1) {
