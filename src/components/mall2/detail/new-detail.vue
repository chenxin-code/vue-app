/**Created by liaoyingchao on 2020/07/23.*/
  ...
  <div class="detail mall2">
    <div ref="detailTop2" class="detail-top"
      ...
      <div class="navcontent"
        ...
        <div class="nav-back-btn" style="left: 4px;top: 5px;width: 34px; height: 34px; padding: 5px;"
        ...
        <!--<transition name="transition1">-->
          <!--<div class="detail-tab" style="left: 20%; right: 20%; font-size: 16px;" v-show="proView == 1">-->
            ...
            <!--<div class="btn-div" :style="getSelectedTabStyle(4)" @click="toptabEvent(4)">-->
              <!--推荐-->
              <!--&lt;!&ndash;<span :class="{theme_border_red_i: toptab == 4, theme_font_red_i: toptab == 4}"></span>&ndash;&gt;-->
            <!--</div>-->
          <!--</div>-->
        <!--</transition>-->
        ...
        <pull-to ref="pullTo1"
          ...
          <div>
            <div class="swiper-div theme_bg_white">
              ...
              <div class="swiper-tip" v-if="detailData.productType == 6">
                <div class="pay-time">
                  <span>每日下单时间：</span>
                  <span class="tm">{{detailData.dailySaleBegin}}</span>
                  <span>至</span>
            ...
            <div class="base-info theme_bg_white">
              <!-- 添加到心愿单 -->
              <div class="add-wish-btn" @click="addWishLish"
                   v-if="$store.state.globalConfig.isEnabledWishOrder == 1 && detailData.deliveryType == 2">
                <img src="../wish-list/images/wish-icon-no.png" alt="" v-if="!detailData.isAddWishOrder">
                <img src="../wish-list/images/wish-icon.png" alt="" v-else>
              </div>
              <!-- 添加到心愿单end -->

              <div class="seconds-kill" v-if="detailData.mktActivityPriceLevel == 3 || (showActivityTime == '1' && detailData.mktActivityPriceLevel != '')">
                <div class="left-div">
                  ...
                  <div class="sk-row" v-else>
                    <div class="price theme_font_white">
                      <PriceOrder :showLevelImg="false" :detailColor="'white'"
                                  :detailitem="detailData"></PriceOrder>
                    </div>
                  </div>
                  <div class="sk-row">
                    <div class="sk-icon">
                    ...
                    <div class="o-price theme_font_white"
                         :class="{'line-through': $store.state.globalConfig.priceShowType == 2}"
                         v-if="detailData.activityPrice < detailData.salePrice">
              ...
              <div class="seconds-kill tgfx" v-else-if="detailData.mktActivityPriceLevel === 0 && tgfxData">
                <div class="left-div">
                  <div class="sk-row">
                    <div class="price theme_font_white">
                      <PriceOrder :showLevelImg="false" :detailColor="'white'"
                  ...
                  <div class="sk-row">
                    ...
                    <div class="tgfx-gz theme_font_white">
                      满{{tgfxData.returnRules[tgfxData.returnRules.length -
                      1].number}}件，返{{tgfxData.returnRules[tgfxData.returnRules.length -
                      1].returnValue}}{{getFxUnit(tgfxData.returnType)}}；
                    </div>
                  </div>
                </div>
                <div class="right-div theme_bg_light_red">
              ...
              <div class="price" v-else>
                ...
                <span class="price-small theme_font_tint left-m-8"
                      v-if="detailData.dpedData.linePrice && detailData.activityPrice < detailData.salePrice"
                      :class="{'line-through': $store.state.globalConfig.priceShowType == 2}">
              ...
              <div class="row" v-if="detailData.packageStartTime && getPackageStartTime()">
              ...
              <div class="row" v-if="noticeIsShow()">
                <div class="activity-notice">
                  <div class="sk-icon">
                    <i class="iconfont mall-icon-test theme_bg_red theme_font_white"></i>
                    <span class="theme_font_red">{{detailData.noticeActivityDetail.activityType}}</span>
                  </div>
              ...
              <div class="row" v-if="detailData.mktActivityPriceLevel === 0 && tgfxData">
            ...
            <div class="block-div theme_bg_white" v-if="productType == 4">
              ...
              <div class="pro-row" v-for="pro in detailData.packageSkuList">
                ...
                <div class="info-div">
                  <div class="title pro-title-height double-line theme_font_black"
                       v-html="getSkuNameStr(pro)"></div>
            ...
            <div class="block-div theme_bg_white"
              ...
              <div class="flex-row">
                <p class="sl-tag line_circle theme_border_red_i theme_font_red">
                  {{curSingleActivity.activityType}}</p>
                <p class="sl-title single-line">{{curSingleActivity.activityTitle}} <span
                  class="theme_standard_font">{{getActivityStr(curSingleActivity)}} ¥{{$util.toDecimal2(curSingleActivity.activityPrice)}}</span>
                </p>
                <p class="good-salespro-right" v-if="singleActivities_2.length > 1"
                   @click="reviseSingleActivity()">修改</p>
                <p class="good-salespro-right" v-if="singleActivities_2.length == 1"
                   @click="removeSingleActivity()">不参加</p>
              </div>
            </div>
            <div class="block-div theme_bg_white"
                 v-if="singleActivities_2.length > 0 && curSingleActivity == null && orderCategory != '1'">
              <div class="flex-row" v-for="saitem in singleActivities_2">
                <p class="sl-tag line_circle theme_standard_bdr_i theme_standard_font">
                  {{saitem.activityType}}</p>
                <p class="sl-title single-line">{{saitem.activityTitle}} <span class="theme_standard_font">{{getActivityPrice(saitem)}} + ¥{{$util.toDecimal2(saitem.activityPrice)}}</span>
                </p>
            ...
            <!--金豆商城无领券-->
            <div class="block-div theme_bg_white"
                 v-if="(!cardType || (cardType && cardType == 551)) && orderCategory != '1'">
              <div class="flex-row" @click="couponEvent" v-if="detailData.couponModels && detailData.couponModels.length > 0">
                <div class="label-middle theme_font_gray">领券</div>
                <div class="font-small theme_font_tint" v-if="detailData.couponModels == '' && jfhqList == ''">
                  暂无可用优惠券
                </div>
            ...
            <!--可用券-->
            <div class="block-div theme_bg_white"
                 v-if="detailData.proCanUseCouList && detailData.proCanUseCouList.length > 0"
                 @click="kyCouponEvent">
              <div class="flex-row">
                <div class="label-middle theme_font_gray">可用券</div>
                <div class="act-item-full theme_standard_bg theme_font_white"
                     v-if="cidx < 2"
                     v-for="(couponModel, cidx) in detailData.proCanUseCouList">{{couponModel.couTypeTitle}}
                </div>
                <div class="full"></div>
                <div>
                  <i class="iconfont mall-gengduo more-icon theme_font_tint"></i>
            ...
            <div class="block-div no-padding-bottom theme_bg_white" v-if="detailData.productType != 5">
              ...
              <!--</div>-->
              <div class="color-row theme_bg_dark" @click="serversEvent" v-if="$store.state.globalConfig.product_services_show_type != '0'">
                ...
                <div class="server-item" v-for="server in detailData.serviceInfoJson">
                  <i class="iconfont mall-dui theme_standard_font icon-font"></i>
                  <span>{{server.name}}</span>
                </div>
              </div>
            </div>
            <div class="block-div theme_bg_white" v-if="$store.state.globalConfig.proDetailStoreDisabled != 1">
              <div class="flex-row" @click="toShop">
                ...
                <div class="act-item-full theme_standard_bg theme_font_white"
                     v-if="detailData.storeType == '0'">自营
                </div>
                <div class="full"></div>
                <div>
            ...
            <div class="block-div theme_bg_white" v-if="detailData && detailData.evaluateCount > 0">
              <div class="flex-row" @click="allCommentEvent">
                <div class="title theme_font_black" v-if="detailData.evaluateCount == 0">暂无评价</div>
                <div class="title theme_font_black" v-if="detailData.evaluateCount > 0">
                  评价（{{detailData.evaluateCount}}）
                </div>
                <div class="full"></div>
                <div class="font-small right-margin theme_font_common" v-if="detailData.evaluateCount > 0">
                  <span>好评率</span>
                  <span class="theme_standard_font">{{detailData.evaluateGoodRate}}</span>
                </div>
                <div>
                  <i class="iconfont mall-gengduojiantou icon-font theme_font_common"></i>
                </div>
              </div>
              <div class="comment-div" v-for="comment in detailData.evaluateList">
                ...
                <div class="pro-div" v-for="item in detailData.packageList" @click="productPickageEvent(item)">
                  ...
                  <div class="price single-line">
                    ...
                    <span class="font-small theme_font_tint left-m-8"
                          v-if="item.dpedData.linePrice && item.activityPrice < item.salePrice"
                          :class="{'line-through': $store.state.globalConfig.priceShowType == 2}">
            ...
            <div class="block-div theme_bg_white"
              ...
              <div class="more-btn">
                <label class="act-item-empty line_circle theme_standard_font theme_standard_bdr"
                       @click="moreRecommend">更多推荐</label>
              </div>
            </div>
            <div class="detail-cont" v-if="proSkuMediaModel">
              <div class="title-row theme_border_red">商品介绍</div>
              <div v-if="introduction1" v-html="introduction1" class="introduction-div-2" id="picMedia"></div>
              <div class="no-data">暂无商品介绍</div>
            </div>
            <div class="detail-cont" v-if="proSkuMediaModel">
              <div class="title-row theme_border_red">规格参数</div>
              <div v-if="introduction2" v-html="introduction2" class="introduction-div-2"></div>
              <div class="no-data">暂无规格参数</div>
            </div>
            <div class="detail-cont" v-if="proSkuMediaModel">
              <div class="title-row theme_border_red">售后包装</div>
              <div v-if="introduction3" v-html="introduction3" class="introduction-div-2"></div>
              <div class="no-data">暂无售后包装</div>
            </div>
            <div class="recommend-div" v-if="proSkuMediaModel">
              <Recommend :deliveryType="this.deliveryType" :skuId="this.skuId"></Recommend>
            </div>
          </div>
        </pull-to>
      </div>
    ...
    <div class="bottom-btns yj-card" v-if="easyCardId  && !recommendCommodity">
      <div class="btn theme_bg_red theme_font_white" @click="buyNowEvent">
    ...
    <div class="bottom-btns" v-else-if="!easyCardId && detailShow && !recommendCommodity">
      ...
      <div class="btn full" @click="toShop" v-if="$store.state.globalConfig.proDetailStoreDisabled != 1">
        <i class="iconfont mall-dianpu btn-icon theme_font_gray"></i>
        <p class="text">店铺</p>
      </div>
      <div class="btn full" @click="collectEvent">
        <i class="iconfont mall-shoucang btn-icon theme_font_gray" v-if="isCollect != 'true'"></i>
      ...
      <div class="btn full" @click="songliEvent"
           v-if="$store.state.globalConfig.send_gift_enable == '1' && stockNum != 0 && canSale == true && detailData.status != '0' && isPayTime()">
        <img class="btn-sl-img" src="./img/sl.png">
        <p class="text">送礼</p>
      </div>
      <div class="btn theme_standard_bg theme_font_white" @click="addToCart"
           v-if="stockNum != 0 && canSale == true && detailData.status != '0' && productType != 511 && detailData.supportPreSale != '1'">
      ...
      <div class="btn big-btn theme_bg_y theme_font_white" @click="preSaleEvent"
           v-if="stockNum != 0 && canSale == true && detailData.status != '0' && isPayTime() && detailData.supportPreSale == '1'">
    ...
    <pop-view v-if="showPop" @closeEvent="popClose">
      <div class="pop-body">
        ...
        <div class="bottom-btn theme_font_white theme_bg_red" @click="popSureEvent"
             v-if="popFlag == 'addToCart' && stockNum != 0 && canSale == true && detailData.status != '0' && detailData.supportPreSale != '1'">加入购物车
        </div>
        <div class="bottom-btn theme_font_white theme_bg_y" @click="noStockEvent"
             v-if="stockNum == 0 && canSale == true && detailData.status != '0'">
          <p class="title">商品缺货</p>
        </div>
        <div class="bottom-btn theme_font_white theme_bg_y" @click="canNotSaleEvent"
             v-if="canSale == true && detailData.status == '0'">
          <p class="title">商品已下架</p>
        </div>
        <div class="bottom-btn theme_font_white theme_bg_y" @click="canNotSaleEvent" v-if="canSale == false">
          <p class="title">不在可售区域</p>
        </div>
        <div class="bottom-btn theme_font_white theme_bg_red" @click="popSureEvent"
        ...
        <div class="bottom-btn theme_font_white theme_bg_red" @click="popSureEvent"
             v-if="popFlag == 'songli'">送礼
        </div>
        <div class="bottom-btn theme_font_white theme_bg_red" @click="popSureEvent"
             v-if="popFlag == 'preSale'">预购下单
        </div>
      </div>
    </pop-view>
      ...
      <div class="pop-body">
        ...
        <div class="pop-scroll-div">
          <div class="activity-div" v-for="(aactivity, aidx) in detailData.activityList"
            ...
            <div class="act-item-empty line_circle theme_border_red theme_font_red">{{aactivity.type}}</div>
      ...
      <div class="pop-body">
        ...
        <div class="pop-scroll-div">
          <div class="activity-div" @click="changeDelivery('1')">
            <div class="act-item-empty line_circle theme_border_red theme_font_red">自提</div>
            <div class="activity-text theme_font_common full">您需要到选中的自提点提货</div>
            <i class="iconfont more-icon"
               :class="detailData.deliveryType == '1' ? ['mall-xuanzhong', 'theme_font_red'] : ['mall-weixuanzhong', 'theme_font_tint']"></i>
          </div>
          <div class="activity-div" @click="changeDelivery('2')">
            <div class="act-item-empty line_circle theme_border_red theme_font_red">配送</div>
            <div class="activity-text theme_font_common full">将会送至您指定的位置</div>
            <i class="iconfont more-icon"
               :class="detailData.deliveryType == '2' ? ['mall-xuanzhong', 'theme_font_red'] : ['mall-weixuanzhong', theme_font_tint]"></i>
          </div>
        </div>
      </div>
    </pop-view>
    ...
    <BigImage :initIndex="videoUrl != '' ? proImgIndex - 1 : proImgIndex" :picUrls="detailData.picUrls"
              v-if="showBigImage"
...
<script>
  ...
  import Recommend from './recommend/new-recommend'
  ...
  export default {
    ...
    methods: {
      ...
      serversEvent: function () {
        ...
        if (serviceInfo != '') {
          ...
          let url = '/app/json/app_pro_sku_service_detail/getServiceDetailListByIds';
          let params = {
      ...
      getPackageStartTime: function () {
        let nowT = this.$store.state.severTime.currentTime
        let startT = this.$util.getDateFromString(this.detailData.packageStartTime)
        if (nowT < startT) {
          return startT
        }
        return 0
      ...
      reviseSingleActivity: function () {
        ...
        for (let i = 0; i < this.singleActivities_2.length; i++) {
          ...
          listData.push({
            ...
            title: item.activityTitle + ' ' + this.getActivityPrice(item) + this.$util.toDecimal2(item.activityPrice),
      ...
      bottomPull: function (loaded) {
        if (this.loadStep == 1) {
          this._getDetailMediaModel(loaded)
        } else {
      ...
      loadJFHQList: async function () {
        ...
        // }
        this.jfhqList = this.detailData.detailExchangeList
      },
      ...
      couponEvent: async function () {
        if (this.detailData.couponInList == '' && this.jfhqList == '') {
      ...
      songliEvent: function () {
        ...
        if (this.deliveryType == 2) {
          // 配送 普通商品和商品包
          if (this.detailData.productType == '1' || this.detailData.productType == '4') {
            if (this.$store.state.mall2.selectAddress.id == '') {
              this.$Toast("请选择配送区域")
              return;
            } else if (!this.$store.state.mall2.selectAddress.provinceId || !this.$store.state.mall2.selectAddress.cityId || !this.$store.state.mall2.selectAddress.countryId) {
              this.$Toast("请选择配送区域")
              return;
            }
          }
      ...
      preSaleEvent: function () {
        ...
        if (this.productType == 511 || this.productType == 510) {  // 卡密商品订单界面
          this.$router.push({
      ...
      _getDetailMediaModel: function (loaded) {
        let url = '/app/json/product_new_edition/getAppProDetailExtendInformation'
        let paramsData = {
          id: this.detailData.id,
          skuId: this.detailData.skuId,
          spuId: this.detailData.spuId,
          storeOuCode: this.detailData.storeOuCode,
          categoryId: this.detailData.categoryId,
          deliverType: this.detailData.deliverType,
        ...
        this.$http.post(url, paramsData).then(
          res => {
            ...
            if (data.status == 0) {
              this.loadStep = 2
              this.proSkuMediaModel = data.data.proSkuMediaModel
              this.introduction1 = this.proSkuMediaModel.mobileDetail.replace(/\<title\>.*\<\/title\>/, '')
              // 这里是临时匹配某些京东商品详情，去掉写死的宽高样式
              this.introduction1 = this.$util.removeWidthAndHeight(this.introduction1)

              this.introduction2 = this.proSkuMediaModel.mobileParam
      ...
      _getProductDetail: function () {
        this.$Loading.open();
        let url = '/app/json/product_new_edition/getAppProDetailNewEdition';
        let paramsData = {
          token: this.$store.state.login.token,
        ...
        if (this.$store.state.globalConfig.app_home_special_flag == 'cnooc' && paramsData.storeOuCode == '') {
          // 海油
          paramsData.deliverType = this.deliveryType
          paramsData.storeOuCode = this.$store.state.mall2.zitiAddress.mchOuCode
          paramsData.pickupStoreOuCode = this.$store.state.mall2.zitiAddress.mchOuCode
        }
        if (this.activityId != '') {
        ...
        if (paramsData.deliverType == 1) {
          ...
          paramsData.pickupStoreOuCode = this.$store.state.mall2.zitiAddress.storeCode ? this.$store.state.mall2.zitiAddress.storeCode : this.$route.query.storeOuCode ? this.$route.query.storeOuCode : '1';
        } else if (paramsData.deliverType == '') {
          paramsData.pickupStoreOuCode = this.$route.query.storeOuCode ? this.$route.query.storeOuCode : '1';
        }

        paramsData.area = {
          provinceId: this.$store.state.mall2.selectAddress.provinceId,
          cityId: this.$store.state.mall2.selectAddress.cityId,
          countyId: this.$store.state.mall2.selectAddress.countryId,
        ...
        this.$http.post(url, paramsData).then(
          res => {
            ...
            if (data.status == 0) {
              ...
              this.$actionStatistics.detailAction('120000', JSON.stringify(paramsData), this.detailData.skuId)
              ...
              if (cActivity && (cActivity.activityPriceLevel == 2 || cActivity.activityPriceLevel === 0)) {
              ...
              for (let i = 0; i < skuAList.length; i++) {
                ...
                if (saitem.activityPriceLevel == 2 || saitem.activityPriceLevel === 0) {
              ...
              this._getCustomStock();
              this.isCollect = this.detailData.checkHasCollection
              // this._getCollectState();
              this.setWxShareArgs();
              // 视频
              this.arrLen = this.detailData.picUrls.length
              // this.playerOptions.poster = this.detailData.proSkuMediaModel.mobilePicUrl || ''
              ...
              if (this.detailData.mktActivityPriceLevel == '2' || this.detailData.mktActivityPriceLevel === 0) {
      ...
      sharegoods: function () { //分享
        ...
        if (shareData.detailurl.indexOf('shareDeliveryType') == -1) {
          shareData.detailurl = shareData.detailurl + '&shareDeliveryType=' + this.detailData.deliveryType;
        }
      ...
      setWxShareArgs: function () {
        if (this.$store.state.webtype == 2) {
          ...
          wxfunc.wxmpShare({
            ...
            path: `${Config.shareUrl}${wxfunc.wxmpPath(this.$route)}`,
      ...
      setPicMedia() {
        const ssdWrap = document.querySelector('.ssd-module-mobile-wrap') || document.querySelector('.ssd-module-wrap')
        if (ssdWrap) {
      ...
      getTgfxDetail: function () {
        this.$http.post('/app/json/app_group_buy_cashback/getGroupCashbackDetail', {
          // skuId: this.detailData.skuId,
          skuId: '373754',
          activityId: '3476'
        }).then(res => {
    ...
    created() {
      ...
      this.spCode = this.$route.query.spCode ? this.$route.query.spCode : ''
