    ...
    <div ref="scrollView" class="scroll-div theme_bg_white" :style="getScrollTop()" v-if="detailShow">
      ...
      <div class="settle-div">
        <div class="cart-icon" @click.stop="showCartProducts = true">
          ...
          <div class="num theme_bg_red">{{num}}</div>
        </div>
        <div class="info">
          <div class="price">
            <span>¥</span>
            <span class="big">{{occurData.amount || 0.0}}</span>
          </div>
          <div class="yf">
...
<script>
  ...
  export default {
        ...
        this.$http.post(url, paramsData).then(
          res => {
            ...
            if (data.status == 0) {
              ...
              sessionStorage.setItem('MDPS_Carts', JSON.stringify(this.carts))
    ...
    created() {
      ...
      let location = localStorage.getItem('Address_List_Seleted')
      if (location) {
        location = JSON.parse(location)
        this.location = location
      }
      let carts = sessionStorage.getItem('MDPS_Carts')
      if (carts) {
