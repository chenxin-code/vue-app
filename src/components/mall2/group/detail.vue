  ...
  <div class="detail mall2">
    <div ref="detailTop2" class="detail-top"
      ...
      <div class="navcontent"
        ...
        <div class="nav-back-btn" style="left: 10px;top: 5px;width: 75px; height: 44px; padding: 5px;"
      ...
      handleCustomer: function() {
        ...
        ysf('config', {
          ...
          success: function(){     // 成功回调
            ...
            ysf("product", {
              show: 1,
              title: that.detailData[0].groupbuySkuName,
              desc: `价格：¥ ${that.detailData.dpedData.integer}.${detailData.dpedData.decimals}`,
