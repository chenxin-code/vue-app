<template>
  <div id="body">
    <nav-top @backEvent="backEvent" title="加油站服务评价">
    </nav-top>
    <nav-content>
      <div class="content">
...
<!--            </div>-->
        ...
        <div class="answer-con star" v-if="answerList.length>0">
          <div class="title-first">请您提出意见，我们将持续改进与提升</div>
...
<!--                  </div>-->
        ...
        <div class="answer-con worker" v-if="answerList.length>0">
