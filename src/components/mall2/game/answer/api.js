...
const commitUrl = '/app/json/questionaire/dailyAnswer' // 提交每道题
const prizeUrl = '/app/json/questionaire/completeAct' // 答题结束后调用返回奖品
const listUrl = '/app/json/questionaire/findDailyAnswerByuserId' // 问券列表
const historyUrl = '/app/json/questionaire/historyDailyAnswerList' // 问券历史列表
