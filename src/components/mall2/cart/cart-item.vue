...
<template>
  <div>
              ...
              <div class="good-info">
                ...
                <div class="good-paras">
                  ...
                  <div :class="{'paras-right':cartitem.isGift == 0 && cartitem.state != 1 &&cartitem.state != 4}">
                    ...
                    <van-stepper v-if="cartitem.isGift == 0 && cartitem.state != 1 &&cartitem.state != 4" v-model="cartitem.number" :min="cartitem.saleNumBegin" :step="cartitem.saleNumStep" :max="cartitem.saleNumMax" @blur="numBlur" @change="numChange" integer/>
    ...
    <!--<div slot="title" class="cart-item">-->
    <!--<div class="cart-item-sel">-->
    <!--<i v-show="cartitem.isGift == 0 || isEditing " class="iconfont font-large"-->
    <!--:class="cartJS.getXZClass(isEditing,cartitem.checked,cartitem.dchecked)"-->
    <!--@click="setCartSel(cartitem,storeitem,occuritem)"></i>-->
    ...
    <!--</div>-->
    <!--<div class="good-detail">-->
    <!--&lt;!&ndash;<div v-if="cartitem.isGift == 1">&ndash;&gt;-->
    <!--&lt;!&ndash;<span class="good-tag theme_border_red  theme_font_red ">赠品</span>&ndash;&gt;-->
    <!--&lt;!&ndash;</div>&ndash;&gt;-->
    <!--&lt;!&ndash;<div v-if="cartitem.isGift == 2">&ndash;&gt;-->
    <!--&lt;!&ndash;<div class="good-tag theme_border_red  theme_font_red ">换购</div>&ndash;&gt;-->
    <!--&lt;!&ndash;</div>&ndash;&gt;-->
    <!--<div class="good-info">-->
    <!--<p class="good-name line-two" :class="getFontColorClass()"><span-->
    <!--class="good-tag theme_border_red  theme_font_red" v-if="cartitem.isGift == 1">赠品</span><span-->
    ...
    <!--<div class="good-paras">-->
    <!--<div class="paras-left">-->
    <!--&lt;!&ndash;<div class="theme_font_red" :class="getFontColorClass()">&ndash;&gt;-->
    <!--&lt;!&ndash;<span class="money-large" v-show="cartitem.pointsPrice != ''">{{cartitem.pointsPrice}}</span>&ndash;&gt;-->
    <!--&lt;!&ndash;<span class="money-small ">{{$mallCommon.getUnitStr(cartitem,'occur')}}</span><span&ndash;&gt;-->
    <!--&lt;!&ndash;class="money-large" v-show="$mallCommon.getShowPrice(cartitem,'occur')">{{getItemAmount(cartitem.price,0)}}.</span><span&ndash;&gt;-->
    <!--&lt;!&ndash;class="money-small " v-show="$mallCommon.getShowPrice(cartitem,'occur')">{{getItemAmount(cartitem.price,1)}}</span>&ndash;&gt;-->
    <!--&lt;!&ndash;</div>&ndash;&gt;-->
    <!--<PriceOrder :productData="cartitem"></PriceOrder>-->
    <!--</div>-->
    ...
    <!--</div>-->
    <!--</div>-->
    <!--&lt;!&ndash;已参加单品活动 级别2&ndash;&gt;-->
    <!--<div class="good-salespro" v-if="singleActivities_2.length > 0 && curSingleActivity != null">-->
    <!--&lt;!&ndash;<div class="good-salespro-left">&ndash;&gt;-->
    <!--<p class="sa-type">{{curSingleActivity.mktActivityType}}</p>-->
    <!--<p class="sl-title single-line">{{curSingleActivity.mktActivityTitle}}</p>-->
    <!--<p class="good-salespro-right" v-if="singleActivities_2.length > 1" @click="reviseSingleActivity()">修改</p>-->
    <!--<p class="good-salespro-right" v-if="singleActivities_2.length == 1" @click="removeSingleActivity()">不参加</p>-->
    <!--</div>-->
    <!--&lt;!&ndash;未参加单品活动 级别2，但是有活动 级别2&ndash;&gt;-->
    <!--<div class="good-salespro" v-for="item in singleActivities_2" v-if="singleActivities_2.length > 0 && curSingleActivity == null">-->
    <!--<p class="sa-type">{{item.mktActivityType}}</p>-->
    <!--<p class="sl-title single-line">{{item.mktActivityTitle}}</p>-->
    <!--<p class="good-salespro-right" @click="joinSingleActivity(item)">参加</p>-->
    <!--</div>-->
