    ...
    <nav-content>
      <div class="scrolcontent" ref="addresslistscrl">
            ...
            >
              ...
              <div class="right-info">
                <div class="name-phone">
                  <span class="realName theme_font_black left-con">{{
                    list.receiverName
                  }}</span>
                  <span class="tel theme_font_black left-con">{{
                    list.mobile
                  }}</span>
                  <span
                    class="default left-con theme_bg_red"
                    v-if="list.isDefault == 1"
                    >默认</span
                  >
                </div>
        ...
        <div v-if="cannotUseList.length > 0">
          ...
          <div
            class="address-cells shadow-cell"
            v-for="(list, idx) in cannotUseList"
          >
            <mt-cell-swipe
              :right="[
                {
            ...
            >
              ...
              >
                ...
                <div class="right-info">
                  <div class="name-phone">
                    <span class="realName theme_font_gray left-con">{{
                      list.receiverName
                    }}</span>
                    <span class="tel theme_font_gray left-con">{{
                      list.mobile
                    }}</span>
                    <span
                      class="default left-con theme_bg_red"
                  ...
                  <div class="address-edit">
                    <p class="address theme_font_gray">
                      {{ list.addressFull }}
                    </p>
                    <div class="edit" @click.stop="editAddress(list)">
                      <i class="iconfont mall-bianji theme_font_gray"></i>
      ...
      <div class="bottom-btn theme_bg_red" @click="addAddressEvent">
        <p>新建收货地址</p>
      </div>
    </nav-content>
  </div>
