      ...
      topTags: [
        {
          id: 0,
          tagName: "加油券",
          tagImageUrl: require("@/deploy/ykgj/views/image/top_01.png"),
          tagAlias: "JY"
        },
        {
          id: 1,
          tagName: "便利店券",
          tagImageUrl: require("@/deploy/ykgj/views/image/top_02.png"),
          tagAlias: "BLD"
        },
        {
          id: 2,
          tagName: "商城券",
          tagImageUrl: require("@/deploy/ykgj/views/image/top_03.png"),
          tagAlias: "SC"
        },
        {
          id: 3,
          tagName: "其他",
          tagImageUrl: require("@/deploy/ykgj/views/image/top_04.png"),
          tagAlias: "QT"
        }
      ],
      tabs: [
