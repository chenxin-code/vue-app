      ...
      <div class="pop-body" v-if="initData.type == 'use'">
        ...
        <div class="pop-tabs">
          <div class="tab-item" @click="canUseCoupon = true">
            ...
            <div class="selected-line" :class="{active: canUseCoupon}"></div>
          </div>
        ...
        <div class="pop-scroll-div">
          <div v-show="canUseCoupon">
            ...
            <Coupon :listType="2" :payAmount="initData.payAmount" :coupons="initData.userCanUseCoupon" @getCouponEvent="getCouponEvent" @couponProducts="couponProducts" @selectedItems="selectedItemsEvent"></Coupon>
        ...
        <div class="bottom-btn" @click="sureEvent" v-if="canUseCoupon">确定</div>
      </div>
...
<style lang="stylus" scoped type="text/stylus">
  ...
  .bottom-btn {
    background: linear-gradient(270deg, rgb(49, 49, 49) 0%, rgb(84, 84, 84) 51%, rgb(49, 49, 49) 100%);
    color #e0c28a;
  }
  .coupon {
    width 100%
